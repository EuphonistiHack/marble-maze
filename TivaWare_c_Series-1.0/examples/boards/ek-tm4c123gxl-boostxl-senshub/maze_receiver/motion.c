...
// ##### INTERNAL BEGIN #####
            UARTprintf("State %5d\t", g_sGestureInst.ui16State);
            UARTprintf("Emit %5d\t", g_sGestureInst.ui16Emit);
            UARTprintf("Roll %5d\t", (int16_t) (g_pfEulers[0] * 1000.f));
...
//*****************************************************************************
bool
MotionKeyboardGet(uint8_t * ui8Modifiers, uint8_t *ui8Key,
